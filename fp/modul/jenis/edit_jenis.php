<div class="col-lg-12">
    <?php if (isset($_POST['edit_simpan'])) {
        ...
        $query = mysqli_query($mysqli, "UPDATE jenis set NAMA_JENIS='$nama_jenis', KETERANGAN='$keterangan' where ID_JENIS= '$id_jenis'")or die('Ada kesalahan pada query insert: '.mysqli_error($mysqli));
