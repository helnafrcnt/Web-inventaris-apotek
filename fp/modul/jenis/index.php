     ...
     <div class="table-responsive table-responsive-data2">
        <table class="table table-data2">
            ...
            <tbody>
                ...
                {
                    $cari = $_POST['cari'];
                    $query = mysqli_query($mysqli, "SELECT * FROM jenis where ID_JENIS like '%$cari%' OR NAMA_JENIS like '%$cari%' OR KETERANGAN like '%$cari%'")or die('Ada kesalahan pada query insert: '.mysqli_error($mysqli));
                }
                else{
                    $query = mysqli_query($mysqli, "SELECT * FROM jenis ORDER BY ID_JENIS ASC") or die('Ada kesalahan pada query insert: '.mysqli_error($mysqli));  
                }
